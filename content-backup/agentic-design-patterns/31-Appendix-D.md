# Appendix D: Building an Agent with AgentSpace | <mark>附录 D：基于 AgentSpace 构建智能体</mark>

[[30-Appendix-C|< Previous Chapter]] | [[000-Home|Home]] | [[32-Appendix-E|Next Chapter >]]

> **Note:** AgentSpace is now renamed to Gemini Enterprise. To maintain consistency with the original text, this translation continues to use the name AgentSpace.
> <mark><strong>注：</strong>AgentSpace 现已更名为 Gemini Enterprise。考虑到与原文保持一致的原则，本译文仍继续采用 AgentSpace 名称。</mark>

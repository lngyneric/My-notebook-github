...
compiled_at: 2026-04-24T05:51:17.456Z
---
<wiki>
# Astrill VPN 配置 Antigravity/Gemini CLI/Claude Code 分离规则教程
## 摘要
本教程用于配置Astrill VPN的分流规则，实现仅Antigravity、Gemini CLI、Claude Code三类工具走美国VPN节点以满足地域限制与API合规要求，同时保持豆包等其他本地应用直连网络，且可与原有NotebookLM分流规则共存无冲突。

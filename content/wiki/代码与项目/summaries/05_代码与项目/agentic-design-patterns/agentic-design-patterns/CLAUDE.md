...
compiled_at: 2026-04-24T08:20:23.257Z
---
# CLAUDE.md: Claude Code Guidance for Agentic Design Patterns Bilingual Translation Project

## Summary
This document defines official guidance for Claude Code (claude.ai/code) when working with content in the Agentic Design Patterns bilingual translation repository. It outlines the project's purpose, structure, mandatory translation and formatting rules, workflows, and reference information to ensure consistent, compliant contributions.

---

## Project Overview
This is a **bilingual Chinese-English translation project** of *Agentic Design Patterns: A Hands-On Guide to Building Intelligent Systems* by Antonio Gulli, which provides a comprehensive technical guide covering 21 core agentic design patterns for building intelligent AI systems.
...
The source book covers these patterns across four parts:

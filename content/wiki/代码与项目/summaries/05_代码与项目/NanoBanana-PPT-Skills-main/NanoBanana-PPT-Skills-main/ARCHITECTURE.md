...
compiled_at: 2026-04-24T08:27:15.921Z
---
<wiki>
# PPT Generator Pro 架构文档

## 摘要
本文档为 AI 驱动的 PPT 生成系统「PPT Generator Pro」的完整架构说明，覆盖从用户文档输入到最终输出的全链路设计，包含核心模块划分、数据流走向、API 集成方案、文件组织规范、交互逻辑、技术栈与性能指标，支持三种输出形态：图片版交互式 PPT、带转场效果的视频版播放器、以及完整可分享的 MP4 视频文件。

---
source: raw/05_代码与项目/NanoBanana-PPT-Skills-main/NanoBanana-PPT-Skills-main/styles/vector-illustration.md
raw_sha256: d5d88ce3c82472618cd6bb4e7e85d42b47376c11a5cea53710e72c332e02cf43
compiled_at: 2026-04-14T04:10:20.314Z
---
# 矢量插画风格 (vector-illustration)

> [!NOTE] TL;DR
> 这是一个适配多AI生成模型的PPT矢量插画风格模板，主打扁平化带黑色轮廓的几何化矢量风格，搭配复古柔和配色和玩具模型般的可爱感，分为封面、内容、数据三类页面模板，可直接套用提示词生成对应PPT页面。
...
| 项目 | 内容 |
|------|------|
| 风格ID | `vector-illustration` |
| 风格名称 | 矢量插画风格PPT |
| 适配模型 | Nano Banana Pro (gemini-3-pro-image-preview)、Notebookml、Youmind、Listenhub、Lovart |

## 风格特点要点
- 扁平化矢量插画，所有元素带清晰统一粗细的黑色封闭轮廓，线条末端圆润
- 复杂物体做几何化简化处理，追求玩具模型般的可爱感，不追求写实
- 采用复古柔和配色：米色背景，搭配珊瑚红、薄荷绿、芥末黄、赭石色、岩石蓝
- 横向全景式构图，插画一般占据版面顶部1/3区域
- 用前后遮挡表现纵深感，所有元素清晰度一致，不使用大气透视、渐变和3D效果
- 适合教育演示、创意提案、儿童内容、品牌展示等场景
...
### 推荐设置
- 推荐分辨率：2K（平衡质量和生成速度）
- 适用场景：教育演示、创意提案、儿童内容、品牌展示等
- 整体风格标签：温暖可爱、易于理解、复古怀旧
...
## 引用来源
> 原始来源路径：`raw/05_代码与项目/NanoBanana-PPT-Skills-main/NanoBanana-PPT-Skills-main/styles/vector-illustration.md`

---
source: raw/05_代码与项目/NanoBanana-PPT-Skills-main/NanoBanana-PPT-Skills-main/styles/gradient-glass.md
raw_sha256: fc90216d8c6824a66158d51e1b5e2770060d6e26d67014ae031662a58daaab94
compiled_at: 2026-04-14T04:10:08.601Z
---
# 渐变拟物玻璃卡片风格（gradient-glass）

> 来源路径：`raw/05_代码与项目/NanoBanana-PPT-Skills-main/NanoBanana-PPT-Skills-main/styles/gradient-glass.md`

---

## TL;DR
本页面记录了适配Nano Banana Pro和Seedream大模型的PPT生成风格「渐变拟物玻璃卡片风格」，该风格融合Apple Keynote极简主义、现代SaaS设计与玻璃拟态效果，适用于产品演示、技术分享等多种场景，提供了可直接复用的基础提示词与分页面类型的生成模板。

---

## 要点
- 风格ID：`gradient-glass`，风格全称：渐变拟物玻璃卡片风格
- 适配模型：Nano Banana Pro (gemini-3-pro-image-preview)、Seedream
- 风格定位：高端洁净、带呼吸感的现代PPT设计风格，融合玻璃拟态与渐变设计
- 核心设计特征：Bento网格布局、磨砂玻璃容器、3D抽象视觉锚点、极光渐变点缀
- 提供了封面页、内容页、数据页三种场景的可复用生成模板
- Nano Banana Pro推荐配置：16:9比例、2K分辨率、IMAGE响应输出
...
### Nano Banana Pro 推荐配置
| 参数 | 配置值 |
| ---- | ---- |
| 模型 | gemini-3-pro-image-preview |
| 比例 | 16:9 |
| 可选分辨率 | 2K (2752x1536) / 4K (5504x3072) |
| 响应模式 | IMAGE |

### 推荐设置
- 推荐分辨率：2K（平衡质量和生成速度）
- 适用场景：产品演示、技术分享、创意提案、数据报告等
